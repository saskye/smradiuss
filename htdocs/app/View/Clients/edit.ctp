			...
			<div class="form-group">
				...
				<div class="row">
					<div class="col-md-4 input-group">
						<?php echo $this->Form->input('Name', array('label' => false, 'class' => 'form-control', 'placeholder' => 'Name', 'value' => $client['Client']['Name'], 'type' => 'text'));?>
					</div>
				</div>
			</div>	
			<div class="form-group">
				...
				<div class="row">
					<div class="col-md-4 input-group">
						<?php echo $this->Form->input('AccessList', array('label' => false, 'class' => 'form-control', 'placeholder' => 'AccessList', 'value' => $client['Client']['AccessList'], 'type' => 'text'));?>
					</div>
				</div>
			</div>		
			<div class="form-group">
