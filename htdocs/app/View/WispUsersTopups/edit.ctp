	...
	<div class="row"><?php echo $this->element('left_panel');?>	
		<div class="col-md-10"><legend><?php echo __('Edit User Topup')?></legend>
			...
			<div class="form-group">
				...
				<div class="row">
					<div class="col-md-4 input-group">
						<?php echo $this->Form->input('Type', array('label' => false, 'class' => 'form-control', 'type' => 'select', 'options' => array('1'=>'Traffic', '2'=>'Uptime'),'value' => $topup['WispUsersTopup']['Type']));?>
					</div>					
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="row">
					<div class="col-md-4 input-group">
					<?php echo $this->Form->input('valid_from', array('label' => false, 'class' => 'form-control', 'id' => 'datepickerFrom', 'readonly'=>'readonly','value' => date("Y-m-d",strtotime($topup['WispUsersTopup']['ValidFrom']))));?>
					</div>
				</div>
			</div>
			<div class="form-group">
