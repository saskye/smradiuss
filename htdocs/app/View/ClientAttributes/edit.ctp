	...
	<div class="row"><?php echo $this->element('left_panel');?>
		<div class="col-md-10"><legend><?php echo __('Edit Client Attribute')?></legend>
			...
			<div class="form-group">
				...
				<div class="row">
					<div class="col-md-4 input-group">
						<?php echo $this->Form->input('Operator', array('label' => false, 'class' => 'form-control', 'type' => 'select', 'options' => array('=', ':=', '==', '+=', '!=', '<', '>', '<=', '>=', '=~', '!~', '=*', '!*', '||=='), 'value' => $clientAttribute['ClientAttribute']['Operator']));?>
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="row">
					<div class="col-md-4 input-group">
						<?php echo $this->Form->input('Value', array('label' => false, 'class' => 'form-control', 'placeholder' => 'Value', 'value' => $clientAttribute['ClientAttribute']['Value'], 'type' => 'text'));?>
					</div>
				</div>
			</div>
			<div class="form-group">
